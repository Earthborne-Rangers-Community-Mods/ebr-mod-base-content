...
**`A) Accompany Dace to the Plummet.`** Discard all <span class="progress"></span> from Dace and attach **HELPING HAND**. Search the Valley Set for Oura Vos, Traveler and set her aside.

**`B) Some other time.`** Discard Dace. Each Ranger soothes 2 fatigue.
