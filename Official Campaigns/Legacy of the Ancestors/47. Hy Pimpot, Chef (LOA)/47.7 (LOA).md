...
**`A) Absolutely!`** Discard all <span class="progress"></span> and attach the **HELPING HAND** mission to Hy Pimpot. *`Make a stew with Hy Pimpot’s test using only cards with the Mycelial keyword.`*
