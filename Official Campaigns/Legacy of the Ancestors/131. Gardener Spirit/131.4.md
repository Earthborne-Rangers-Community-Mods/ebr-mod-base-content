...
**`A) Accompany the spirit.`** Discard all <span class="progress"></span> from the Gardener Spirit and attach the mission **HELPING HAND** to her. *`Travel to the Arboretum of Memory and clear the Gardener Spirit with <span class="progress"></span> while New Growth is in play.`*

**`B) Another time perhaps.`** Discard the Gardener Spirit. Place 1 <span class="progress"></span> on each flora in play.
