...
**`A) Help Calypsa look for the reclaimer.`** Discard all <span class="progress"></span> from Calypsa and attach **HELPING HAND**. Search the General set for a Reclaimer Seeker and shuffle it into the bottom 5 cards of the path deck. *`Clear Calypsa with <span class="progress"></span> while a Reclaimer Seeker is in the path discard to analyze it.`*

**`B) Some other time.`** Discard Calypsa. Each Ranger soothes 2 fatigue.
