...
**`A) Continue leading the spirit.`** Discard <span class="progress"></span> from the Wanderer Spirit. *`Travel to a location three or more paths away from the noted location, then clear the Wanderer Spirit with <span class="progress"></span>.`*
