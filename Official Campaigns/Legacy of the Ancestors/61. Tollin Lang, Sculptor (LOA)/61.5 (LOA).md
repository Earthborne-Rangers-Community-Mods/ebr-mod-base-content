...
**`A) Help Tollin tune his prototype instrument.`** Discard all <span class="progress"></span> from Tollin and attach **HELPING HAND**. Shuffle each unused Aspect card and deal 5 of them facedown in a row outside the play area. This is the lithophone. *`Clear Tollin with <span class="progress"></span> while HELPING HAND is attached to help him tune the lithophone.`*

**`B) Some other time.`** Discard Tollin. Each Ranger soothes 2 fatigue.
