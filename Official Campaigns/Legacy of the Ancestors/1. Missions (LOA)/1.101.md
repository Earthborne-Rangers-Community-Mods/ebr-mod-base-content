...
Gain the **SEARCH BELOW (SILARO MAKO)** mission. Search the Chimney set for Silaro Mako, Spelunker and attach him facedown to the mission card. Cross off `199.2` on the day tracker. Write `199.3` 3 days from now on the day tracker. *`Find Silaro Mako and return him to the base camp at the Chimney.`*
